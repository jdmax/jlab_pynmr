...
class AnalTab(QWidget):
    ...
    def update_event_plots(self):
        ...
        if (self.current_event and hasattr(self.current_event, 'basesweep') and 
            ...
            self.raw_plot.setData(freqs, self.current_event.scan.phase - self.current_event.scan.phase.max())
            self.base_plot.setData(freqs, self.current_event.basesweep - self.current_event.basesweep.max())
